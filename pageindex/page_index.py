...
def generate_toc_continue(toc_content, part, model="gemini-3.1-pro-preview"):
...
################### fix incorrect toc #########################################################
def single_toc_item_index_fixer(section_title, content, model="gemini-3.1-pro-preview"):
    tob_extractor_prompt = """
